...
export function generateQuestionsForConcern(concern: FinancialConcern): Question[] {
  const questionMap: Record<FinancialConcern, Question[]> = {
    debt_stress: [
      {
        id: 'debt_type',
        text: "What kind of debt? Credit cards, student loans, car loan?",
      ...
      {
        id: 'debt_total',
        text: "Roughly how much total?",
        category: 'debt_amount',
        priority: 9,
        expectedFormat: 'number',
        followUp: "Across all of it?",
      },
      {
        id: 'highest_interest',
        text: "What's the interest rate on the highest one?",
        category: 'debt_interest',
        priority: 9,
        expectedFormat: 'number',
        followUp: "Do you know the rates on the others?",
      },
      {
        id: 'monthly_income',
        text: "What's your monthly take-home?",
        category: 'income',
        priority: 8,
        expectedFormat: 'number',
        followUp: "After taxes?",
      },
      {
        id: 'essential_expenses',
        text: "What do you spend on essentials each month? Rent, food, utilities, that kind of thing.",
        category: 'expenses',
        priority: 8,
        expectedFormat: 'number',
      ...
      {
        id: 'current_savings',
        text: "How much do you have in savings right now?",
        category: 'savings',
        priority: 7,
        expectedFormat: 'number',
        followUp: "Is that in an emergency fund or mixed in?",
      },
    ],
    savings_gap: [
      {
