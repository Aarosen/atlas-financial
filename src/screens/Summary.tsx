  ...
  return (
    <ScreenWrap>
      ...
      <PageContainer style={{ paddingTop: 'var(--padY)', paddingBottom: 'var(--padY)' }}>
        <Stack gap={14}>
          <Card>
            <div style={{ fontWeight: 950, fontSize: 'var(--fsH2)', letterSpacing: '-0.02em' }}>Here’s what I’m hearing so far</div>
          ...
          <Card>
            <div style={{ color: 'var(--ink2)', lineHeight: 1.7 }}>Next, I’ll choose the right tier based on what I’m hearing (not a label — just a way to pick the right move at the right time).</div>
